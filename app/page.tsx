...
const features = [
  ...
  },
  {
    ...
    description: "Точный и ИИ семантический поиск. Лимиты по тарифу: от 5+2 ключевых слов (Базовый) до 100+50 (Бизнес).",
  },
  {
    icon: Brain,
    title: "ИИ-анализ",
...
// Лимиты тарифов соответствуют настройкам в plans.py (Базовый / Про / Бизнес)
const plans = [
  {
    name: "Базовый",
    price: "1 490",
    ...
    features: [
      "5 ключевых слов (точных) + 2 (ИИ семантика)",
      "2 группы каналов, до 5 каналов",
      "2 своих канала для мониторинга",
      "Уведомления в Telegram и на email",
      "Лента упоминаний и отметка лидов",
    ],
    popular: false,
  },
  {
    ...
    features: [
      "30 ключевых слов (точных) + 10 (ИИ семантика)",
      "10 групп каналов, до 30 каналов",
      "10 своих каналов",
      "Уведомления в реальном времени",
      "ИИ семантический поиск, трекинг лидов",
    ],
    popular: true,
  },
  {
    ...
    features: [
      "100 ключевых слов (точных) + 50 (ИИ семантика)",
      "50 групп каналов, до 200 каналов",
      "50 своих каналов",
...
const faqItems = [
  ...
  {
    question: "Сколько групп и каналов можно отслеживать?",
    answer: "Базовый: 2 группы каналов и до 5 каналов (2 своих). Про: 10 групп, до 30 каналов (10 своих). Бизнес: 50 групп, до 200 каналов (50 своих). Можно подписываться на группы каналов по тематикам и добавлять свои публичные группы и каналы.",
  },
  {
  ...
  },
  {
    ...
    answer: "На всех платных тарифах (Базовый, Про, Бизнес) можно настроить мгновенные уведомления в Telegram и по email. Время доставки — несколько секунд после появления упоминания.",
  },
]
